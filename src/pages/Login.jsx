...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center h-[100vh]">
        <a className='w-[200px] p-2 rounded-md bg-[green] text-white font-semibold text-[20px] text-center hover:opacity-50 duration-300' href={AUTH_URL}>Login to Spotify</a>
    </div>
  )
}
